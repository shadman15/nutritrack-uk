...
CREATE TABLE "FoodItem" (
    ...
    "category" TEXT,
    "superstore" TEXT,
    "per100gKcal" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "per100gProtein" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "per100gCarbs" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "per100gFat" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "per100gFibre" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "per100gSalt" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "per100gSugar" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "per100gSaturates" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "imageUrl" TEXT,
...
CREATE TABLE "DiaryEntry" (
    ...
    "saturatesG" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AddForeignKey
ALTER TABLE "DiaryEntry" ADD CONSTRAINT "DiaryEntry_foodItemId_fkey" FOREIGN KEY ("foodItemId") REFERENCES "FoodItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
